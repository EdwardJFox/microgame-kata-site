...
const KataSubmitted = ({ location }) => {
  return (
    <Layout location={location} title="Thanks!">
      ...
      <p className="lead">I'll get around to adding it as soon as possible. In the mean time, see if any of the other katas are of interest, or take what you did and try something new!</p>
    </Layout>
  )
}
